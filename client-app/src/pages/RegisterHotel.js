            ...
            <MainContainer>
                <section>
                    ...
                    <Card1 width={"850px"}>
                        ...
                        <input type="text" className="form-control input_half" id="property_name" onChange={e => setName(e.target.value)}
                        ...
                        <Dropdown isOpen={dropDownOpen} toggle={toggleDropDown} group>
                            ...
                            <DropdownMenu style={{ width: "50%" }}>
                                <DropdownItem className="dropdown_items" onClick={(e) => setStarRate("1 Star")}>1 Star</DropdownItem>
                                <DropdownItem className="dropdown_items" onClick={(e) => setStarRate("2 Star")}>2 Star</DropdownItem>
                                <DropdownItem className="dropdown_items" onClick={(e) => setStarRate("3 Star")}>3 Star</DropdownItem>
                                <DropdownItem className="dropdown_items" onClick={(e) => setStarRate("4 Star")}>4 Star</DropdownItem>
                                <DropdownItem className="dropdown_items" onClick={(e) => setStarRate("5 Star")}>5 Star</DropdownItem>
                            </DropdownMenu>
                        </Dropdown>

                        <div className="title_3 mt-3">Description</div>
                        <textarea className={"text_area"} name="postContent" rows={5} onChange={(e) => setDescription(e.target.value)} />
                    </Card1>
                </section>
                ...
                <section>
                    ...
                    <div className={"pt-3"} style={{ marginLeft: "20px" }}>
                        <FormGroup check inline>
                            <Input type="checkbox" style={{ width: 25, height: 25 }} onChange={e => setIsCondition1Checked(e.target.checked)} />
                            &nbsp;&nbsp;&nbsp;
                    ...
                    <div className={"pt-3"} style={{ marginLeft: "20px" }}>
                        <FormGroup check inline>
                            <Input type="checkbox" style={{ width: 25, height: 25 }} onChange={e => setIsCondition2Checked(e.target.checked)} />
                            &nbsp;&nbsp;&nbsp;
                            <Label check>
                                <div className={"title_4"}>
                ...
                <div className={"row center_div pt-3"}>
                    <button className={"complete_registration_button"} style={{ width: "650px" }} disabled={registerButtonDisable || !(isCondition1Checked && isCondition2Checked)} onClick={submitForm}>Complete registration
                    </button>
                </div>
